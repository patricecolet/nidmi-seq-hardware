...
- **FIGÉ** : **TFT 4,0″ 480×320, ILI9488, SPI, non tactile** (cf. [`ARCHITECTURE.md`]
  (ARCHITECTURE.md) → Écran). Zone active ~85×56 mm (paysage). Module commerce simple.
- **Qui pilote** : le **cerveau**, en **SPI** (~6 fils), sur GPIO non-touch (>14) pour
  laisser GPIO 1-14 au capacitif. Pas de puce écran dédiée. Partial refresh.
- **Broches** : SCK, MOSI, CS, DC, RST, BL ; tactile XPT2046 du module **non câblé**.
- **Contrôleur** : ILI9488 (ST7796 = plus rapide si dispo).
...
- [x] Écran : 4,0″ 480×320 ILI9488 SPI (figé). Reste : brochage SPI exact sur pins >14.
